...
from introducir import buleano
from introducir import cadena
from introducir import numero
...
def jugar_tirada(self):
        ...
        while True:
            nombre_casilla = cadena.solicitar_introducir_casilla(
...
def elegir_jugarOtra():
    return buleano.solicitar_introducir_si_o_no(
